    ...
    return (
        <div className='bg-[#272727] h-auto rounded-t-[20px] relative overflow-x-hidden' >
            ...
            <div className='z-10 w-[90%] mx-auto flex md:flex-row flex-col justify-between gap-10 md:gap-0 items-center py-20'>
                ...
                <Fade direction='up' triggerOnce cascade delay={500}>
                    <Link href="/plans" className='bg-white rounded-full px-12 py-3 md:px-16 md:py-4 text-black hover:text-[--white] cursor-pointer text-lg font-medium tracking-wide hover:bg-[--secondary] z-10'>Start Creating</Link>
                </Fade>
            </div>

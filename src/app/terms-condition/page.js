...
const Page = () => {
    return (
       ...
       <p className='mt-4'>
           This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy, and Terms of Use for access or usage of domain name <a href='https://eeveegoldsavings.com' className='text-blue-500'>https://eeveegoldsavings.com</a> ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
       </p>
       <p className='mt-4'>
